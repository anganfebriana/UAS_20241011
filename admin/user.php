                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Data Kelas B</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu" style="padding-top: 0px">
                                <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                                <li><span class="bread-blod">kelas B</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Mahasiswa Semester 5 Kelas B</h3>
        </div>
        <div class="panel-body">

            <div class="pull-right">
                <a href="user_tambah.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Mahasiswa</a>
            </div>
            <br>
            <br>
            <br>
