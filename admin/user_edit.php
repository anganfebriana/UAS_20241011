        ...
        <div class="col-lg-6">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Data Kelas B</h3>
                </div>
                <div class="panel-body">
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <form method="post" action="user_update.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" name="email" required="required" value="<?php echo $d['mahasiswa_email']; ?>">
                            </div>

                            <div class="form-group">
                                <label>Jurusan</label>
                                <input type="text" class="form-control" name="jurusan" required="required" value="<?php echo $d['mahasiswa_jurusan']; ?>">
                            </div>
